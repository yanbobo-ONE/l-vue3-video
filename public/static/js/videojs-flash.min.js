...
;(function (global, factory) {
   ...
   */
    ...
    Flash.prototype.getVideoPlaybackQuality =
      function getVideoPlaybackQuality() {
        var videoPlaybackQuality = this.el_.vjs_getProperty(
          'getVideoPlaybackQuality'
        )

        if (
          window_1.performance &&
          typeof window_1.performance.now === 'function'
        ) {
          ...
          videoPlaybackQuality.creationTime =
            window_1.Date.now() - window_1.performance.timing.navigationStart
        }
  ...
  Flash.version = function () {
    ...
    // IE
    try {
      version$$1 = new window_1.ActiveXObject('ShockwaveFlash.ShockwaveFlash')
        .GetVariable('$version')
        .replace(/\D+/g, ',')
        .match(/^,?(.+),?$/)[1]
